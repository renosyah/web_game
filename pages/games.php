        ...
        <div class="col s12 m6 l3">
            <div class="card">
                ...
                <div class="card-action">
                    <a class="black-text" href="<?php echo "$value->game_url?game_id=$value->id&player_id=admin001&player_name=admin" ?>" target="_blank">Play</a>
...
<div class="container">
    <ul class="center pagination">
        <li class="waves-effect"><a href="<?php echo "$menu&$prevPage" ?>"><i class="material-icons">chevron_left</i></a></li>
        <li class="waves-effect"><a href="<?php echo "$menu&$nextPage" ?>"><i class="material-icons">chevron_right</i></a></li>
    </ul>
</div>
